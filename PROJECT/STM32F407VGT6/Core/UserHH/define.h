...
#define RECT_WIDTH        40.0f   // 矩形宽度（水平方向角度范围）
#define RECT_HEIGHT       20.0f   // 矩形高度（垂直方向角度范围）
...
// 圆参数（可调整）
#define CIRCLE_CENTER_X     90.0f   // 圆心X坐标(角度)
#define CIRCLE_CENTER_Y     90.0f   // 圆心Y坐标(角度)
#define CIRCLE_RADIUS       15.0f   // 圆半径(角度)
#define CIRCLE_POINTS       720      // 采样点数（越大越平滑）
#define CIRCLE_SPEED        20      // 每点延时(ms)
...
#define SIN_HORIZONTAL_RANGE 60.0f  // 水平扫描范围
#define SIN_POINT_COUNT  720    // 轨迹点数
